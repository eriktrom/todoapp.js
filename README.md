A remake of the emberjs todo app from emberjs.com, with a focus on testing, javascript build tools, managing modules and easy deployment. Currently it uses CoffeeScript for code readability.
